...
export function oracleEdge(initial=[]){
 ...
 runInNewContext(source,{createClient:()=>db,Deno:{env:{get:()=>''},serve:fn=>{handler=fn;}},TextEncoder,Uint8Array,crypto:globalThis.crypto,Response,URL,Date});
