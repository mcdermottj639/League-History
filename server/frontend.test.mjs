...
test('season odds add each locked price per member and never multiply them as a parlay',async()=>{
 ...
 assert.match(html,/McD<\/b><span>2–0 · 100%<small class="pn-block">-150 avg · -300 total · 2 priced/);
 // Hurd's +100 and -120 is the owner's own example shape: added, it reads -20.
 assert.match(html,/Hurd<\/b><span>1–1 · 50%<small class="pn-block">-10 avg · -20 total · 2 priced/);
...
test('unlocked, unpriced and flagged legs are excluded from the odds tally and the shortfall is visible',async()=>{
 ...
 assert.match(html,/Hurd<\/b><span>1–1 · 50%<small class="pn-block">\+100 avg · \+100 total · 1 priced/);
 assert.match(html,/Slemp<\/b><span>0–1 · 0%<small class="pn-block">\+200 avg · \+200 total · 1 priced/);
 assert.match(html,/Zach<\/b><span>2–0 · 100%<small class="pn-block">-110 avg · -110 total · 1 priced/);
});
