// Nectars Bolonga service worker — network-first so you always get the newest
...
const CACHE = 'leaguehistory-v104';

self.addEventListener('install', () => self.skipWaiting());
self.addEventListener('activate', (e) => e.waitUntil(
  // Drop any older leaguehistory-* caches, then take control of open pages.
  caches.keys()
